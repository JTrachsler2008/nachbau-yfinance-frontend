 ...
 *
 * Nur für Tests. Der Zweck ist, die in `planung/design-theme.md` dokumentierten Kontrastwerte
 * prüfbar zu machen: das Original verfehlte an zwei Stellen WCAG AA, und ohne Test fällt eine
 * spätere Farbänderung genau dort wieder heraus, ohne dass es jemand merkt.
 */
...
function parseColor(color: string): Rgba {
  ...
  if (hex === null) {
    throw new Error(`Nicht unterstütztes Farbformat: ${color}`)
  }
...
/**
 * Legt eine teiltransparente Farbe auf einen deckenden Grund. Notwendig für die Dark-Mode-Badges,
 * deren Fläche `alpha(farbe, 0.15)` ist. Ohne Komposition wäre ihr Kontrast nicht berechenbar.
 */
...
/**
 * Kontrastverhältnis zwischen Vordergrund und Grund, Wertebereich 1 bis 21.
 ...
 * Gebraucht, wenn auf einer teiltransparenten Fläche wiederum Text liegt (Dark-Mode-Badges).
 */
