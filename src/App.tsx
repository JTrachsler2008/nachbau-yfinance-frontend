 ...
 * aussen um die Routen, weil auch die Login-Seite ihn braucht. Dasselbe gilt für den
 * `NotificationProvider`: er leitet bei einem 403 um und muss auch die Login-Seite abdecken, weil ein
 * 500er beim Anmelden ebenso eine Meldung verdient.
 */
function App() {
  return (
    <AuthProvider>
